    ...
    <div class="col-md-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          ...
          <a href="index.php?command=castlist&show_id=<?= htmlspecialchars($show["show_id"]) ?>" class="btn btn-outline-secondary">Open Cast</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          ...
          <a href="index.php?command=characters&show_id=<?= htmlspecialchars($show["show_id"]) ?>" class="btn btn-outline-secondary">Manage</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          ...
          <a href="index.php?command=props&show_id=<?= htmlspecialchars($show["show_id"]) ?>" class="btn btn-outline-secondary">Manage</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          ...
          <a href="index.php?command=costumes&show_id=<?= htmlspecialchars($show["show_id"]) ?>" class="btn btn-outline-secondary">Manage</a>
        </div>
      </div>
    </div>
