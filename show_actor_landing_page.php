...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    ...
    <div class="d-flex gap-2">
      ...
      <a href="index.php?command=logout" class="btn btn-outline-light btn-sm">Log Out</a>
    </div>
  </div>
</nav>
...
<main class="container my-5">
    ...
    <div class="col-md-6">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          ...
          <a href="index.php?command=rehearsal&show_id=<?= $show["show_id"] ?>"
  ...
  <div class="mt-4">
    <a href="index.php?command=showpage&show_id=<?= $show["show_id"] ?>" class="btn btn-primary">
